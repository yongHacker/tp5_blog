<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"E:\PHP\wamp\www\tp5_blog\public/../application/index\view\index\index.htm";i:1512030227;s:73:"E:\PHP\wamp\www\tp5_blog\public/../application/index\view\common\head.htm";i:1512030169;s:74:"E:\PHP\wamp\www\tp5_blog\public/../application/index\view\common\right.htm";i:1512022598;s:75:"E:\PHP\wamp\www\tp5_blog\public/../application/index\view\common\footer.htm";i:1511629424;}*/ ?>
...
<body>
    ...
    <div class="ladytop">
    <div class="nav">
        <div class="left"><a href="<?php echo url('Index/index'); ?>"><img src="__PUBLIC__/images/hunshang.png" alt="网站Logo"></a></div>
        <div class="right">
            <div class="box">
...
<div class="hotmenu">
    <div class="con">
        ...
        <a href="http://localhost:82/tp5/public/index.php/index/search/index.html?keywords=<?php echo $vo['tagname']; ?>"><?php echo $vo['tagname']; ?></a>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
</div>
        ...
        <?php if(is_array($articles) || $articles instanceof \think\Collection || $articles instanceof \think\Paginator): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <div class="xnews2">
                <div class="pic"><a target="_blank" href="<?php echo url('Article/index',array('articleId'=>$vo['id'])); ?>">
                    <img src="<?php if($vo['pic'] != ''): ?>__IMG__/uploads/<?php echo $vo['pic']; else: ?>__IMG__/uploads/error.png<?php endif; ?>" alt="<?php echo $vo['title']; ?>"/></a></div>
                <div class="dec">
                    ...
                    <div class="time">
                        <?php
                            ...
                            foreach($arr as $v){
                                echo "<a href='http://localhost:82/tp5/public/index.php/index/search/index?keywords=$v'> $v </a>";
                        }
                        ?>
                    </div>
                </div>
                            ...
                            <?php if(is_array($clickres) || $clickres instanceof \think\Collection || $clickres instanceof \think\Paginator): $i = 0; $__LIST__ = $clickres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <li class="hm-t-item hm-t-item-img">
                                    <a data-pos="0" title="<?php echo $vo['title']; ?>" target="_blank"
                                       href="<?php echo url('Article/index',array('articleId'=>$vo['id'])); ?>" class="hm-t-img-title"
                ...
                <div class="hm-t-main">
                    ...
                    <div class="hm-t-body">
                        <ul class="hm-t-list hm-t-list-img">
                            <?php if(is_array($clickres) || $clickres instanceof \think\Collection || $clickres instanceof \think\Paginator): $i = 0; $__LIST__ = $clickres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <li class="hm-t-item hm-t-item-img">
                                    <a style="visibility: visible;" class="hm-t-img-title" href="<?php echo url('Article/index',array('articleId'=>$vo['id'])); ?>"
...
<div style="display:none;">
    <script src='__PUBLIC__/style/goto/my-65537.js' language='javascript'></script>
    <script src="__PUBLIC__/images/js/count_zixun.js" language="JavaScript"></script>
</div>
